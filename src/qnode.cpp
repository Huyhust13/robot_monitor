...
#include <sstream>
#include "../include/robot_monitor/qnode.hpp"
#include <QDebug>
/*****************************************************************************
** Namespaces
*****************************************************************************/
...
QNode::QNode(int argc, char** argv ) :
    ...
    {
//    读取topic的设置
    QSettings topic_setting("topic_setting","robot_monitor");
...
bool QNode::init() {
	ros::init(init_argc,init_argv,"robot_monitor");
	if ( ! ros::master::check() ) {
		return false;
	}
...
bool QNode::init(const std::string &master_url, const std::string &host_url) {
	...
	ros::init(remappings,"robot_monitor");
	if ( ! ros::master::check() ) {
		return false;
	}
	ros::start(); // explicitly needed since our nodehandle is going out of scope.
