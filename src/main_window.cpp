...
#include <QMessageBox>
#include <iostream>
#include "../include/robot_monitor/main_window.hpp"
...
void MainWindow::initVideos()
{
   ...
   QSettings video_topic_setting("video_topic","robot_monitor");
...
void MainWindow::slot_set_return_point()
{
    ...
    //写入setting
    QSettings settings("return-position", "robot_monitor");
...
void MainWindow::ReadSettings() {
    QSettings settings("Qt-Ros Package", "robot_monitor");
    ...
    QSettings return_pos("return-position","robot_monitor");
    ...
    //读取快捷指令的setting
    QSettings quick_setting("quick_setting","robot_monitor");
